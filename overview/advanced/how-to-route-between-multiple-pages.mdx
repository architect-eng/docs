...
<Step title="Navigate to Page Links">
  Go to **Pages** in the left sidebar, select the page group you want to test, and click the **Page Links** tab.

  <Frame caption="The Page Links tab shows all existing links for your page group">
    <img src="/overview/images/pmax-ab-test-page-links-tab.png" alt="Architect Page Links tab showing existing page links for a page group" />
  </Frame>
</Step>
