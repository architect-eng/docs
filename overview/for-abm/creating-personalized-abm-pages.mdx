      ...
      <div className="relative z-10 space-y-16 md:space-y-24">
        ...
        <div className="flex flex-col md:flex-row-reverse gap-8 md:gap-12 lg:gap-16 items-center">
          <div className="flex-1 w-full">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl md:text-3xl font-bold tracking-tight">Create a new Group and choose a final destination</h2>
            </div>
            <p className="text-base md:text-lg text-gray-500 mb-4 leading-relaxed">
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-12 lg:gap-16 items-center">
          <div className="flex-1 w-full">
            ...
            <p className="text-base md:text-lg text-gray-500 mb-4 leading-relaxed">
              Go to the People tab and bulk create pages for each prospect. The agent will generate a personalized page for every person in your list.
            </p>
          </div>
          <div className="flex-1 w-full">
            <div className="rounded-xl overflow-hidden border border-gray-200 bg-gray-50">
